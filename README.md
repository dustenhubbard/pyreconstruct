...
No Python required. Direct downloads for the current stable release, **v1.22.2**:

| Platform | Download |
| -------- | -------- |
| Windows (x86_64) | [PyReconstruct-1.22.2-Windows-x86_64-Setup.exe](https://github.com/dustenhubbard/PyReconstruct/releases/download/v1.22.2/PyReconstruct-1.22.2-Windows-x86_64-Setup.exe) |
| macOS (Apple Silicon) | [PyReconstruct-1.22.2-macOS-arm64.dmg](https://github.com/dustenhubbard/PyReconstruct/releases/download/v1.22.2/PyReconstruct-1.22.2-macOS-arm64.dmg) |
| macOS (Intel) | [PyReconstruct-1.22.2-macOS-x86_64.dmg](https://github.com/dustenhubbard/PyReconstruct/releases/download/v1.22.2/PyReconstruct-1.22.2-macOS-x86_64.dmg) |
| Linux (x86_64) | [PyReconstruct-1.22.2-Linux-installer.tar.gz](https://github.com/dustenhubbard/PyReconstruct/releases/download/v1.22.2/PyReconstruct-1.22.2-Linux-installer.tar.gz) |
