...
def get_field_menu_list(self):
    ...
    return [
        ...
        None,
        # routed by focus (main's list-selection feature): a focused list gets
        # the selection command, otherwise the field does -- the same rule
        # backspace() and copy() follow
