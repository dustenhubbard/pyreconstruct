...
# behavior added on main after this line froze. The seeding never rode a pick,
# so the assertion pins infrastructure this line does not have. The app-facing
# once-per-version behavior is covered by the rest of this file unchanged.
